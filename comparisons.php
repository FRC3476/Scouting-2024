...
<script>
  ...
  function createSummaryData1(data){
    ...
    for (var i = 0; i != data.length; i++){
      ...
      pointsMaxAuto1 = Math.max(pointsMaxAuto, getMatchPointsAuto(row));   //Max Points Auto
      pointsMaxTeleop1 = Math.max(pointsMaxTeleop, getMatchPointsTeleop(row));   //Max Points Teleop
      pointsMax1 = Math.max(pointsMax, getMatchPoints(row));   //Max Points
      piecesMax1 = Math.max(piecesMax, getNotes(row));         //Max Pieces
      ...
      aTotalMax1 = Math.max(aTotalMax, getAutoPieces(row));
      aSpeakerMax1 = Math.max(aSpeakerMax, getSpeakerAuto(row));
      aAmpMax1 = Math.max(aAmpMax, getAmpAuto(row));
      ...
      tTotalMax1 = Math.max(tTotalMax, getTeleopPieces(row));
      tAmpMax1 = Math.max(tAmpMax, getAmpTeleop(row));
      tSpeakerMax1 = Math.max(tSpeakerMax, getSpeakerTeleop(row));
      tAmplifiedSpeakerMax1 = Math.max(tAmplifiedSpeakerMax, getSpeakerAmplifiedTeleop(row));
      tTrapMax1 = Math.max(tTrapMax, getTrapTeleop(row));
    ...
    if (matchCount1 > 0){
      // Calculate avg.
      pointsAuto1 = (pointsAuto1 / matchCount).toFixed(2);
      pointsTeleop1 = (pointsTeleop1 / matchCount).toFixed(2);
      pointsTotal1 = (pointsTotal1 / matchCount).toFixed(2);
      piecesTotal1 = (piecesTotal1 / matchCount).toFixed(2);
      aMobility1 = (aMobility1 / matchCount).toFixed(2);
      aTotal1 = (aTotal1 / matchCount).toFixed(2);
      aSpeaker1 = (aSpeaker1 / matchCount).toFixed(2);
      aAmp1 = (aAmp1 / matchCount).toFixed(2);
      tTotal1 = (tTotal1 / matchCount).toFixed(2);
      tSpeaker1 = (tSpeaker1 / matchCount).toFixed(2);
      tAmplifiedSpeaker1 = (tAmplifiedSpeaker1 / matchCount).toFixed(2);
      tAmp1 = (tAmp1 / matchCount).toFixed(2);
      tTrap = (tTrap1 / matchCount).toFixed(2);

      climbNotInStage1 = (climbNotInStage1 / matchCount).toFixed(2);
      climbInStage1 = (climbInStage1 / matchCount).toFixed(2);
      climb1 = (climb1 / matchCount).toFixed(2);
      climbTrap1 = (climbTrap1 / matchCount).toFixed(2);
      climbPoints1 = (climbPoints1 / matchCount).toFixed(2);
      climbPointsMax1 = (climbPointsMax1 / matchCount).toFixed(2);
      Harmony1 = (Harmony1 / matchCount).toFixed(2);
      Spotlighed1 = (Spotlighed1 / matchCount).toFixed(2);
  ...
  function createPieceChart1(data){
    ...
    var ctx1 = document.getElementById('pieceChart');
  ...
  function createEndgameChart1(data){
    ...
    var ctx1 = document.getElementById('endgameChart');

    endgameChart1 = new Chart(ctx, {
      data: {
        datasets: [{
          type: 'bar',
          label: 'Park',
